...
- Inheritance:
  > One class inherits from another class, like a child inherits from their parent.
- Encapsulation:
  > Making certain features private or public
- Abstraction:
  > Basically taking a bunch of details and genralizing it. Like a car does many things when it drives but you just call a function drive.
- Polymorphism:
  > Basically makes a function usable in many different scenarios. Like an add function that adds numbers and strings. 
